...
> FALSE.
>
> In addition to the above versions of the csv format, you should
> develop the habits of looking at and record some parameters of your
> csv files. For instance, the character encoding, control characters
> used for line ending, date format (if the date is not splitted into
> three variables), and the presence of unexepected
...
Something went wrong: some dates have missing values. Let's investigate
